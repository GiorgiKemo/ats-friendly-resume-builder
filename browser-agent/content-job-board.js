...
(() => {
  ...
  const isGenericOptionalFreeTextField = (fieldMeta = '') => {
    ...
    return !/(cover[\s_-]*letter|message[\s_-]*to[\s_-]*the[\s_-]*hiring[\s_-]*team|about[\s_-]*you|tell[\s_-]*us[\s_-]*about[\s_-]*yourself|why (?:are you interested|this role|do you want)|why[\s_-]*should[\s_-]*we[\s_-]*hire[\s_-]*you|why[\s_-]*are[\s_-]*you[\s_-]*a[\s_-]*fit|describe|explain|experience|availability|schedule|license|certification|portfolio|website|linkedin|github|visa|sponsorship|work[\s_-]*authorization|salary|compensation)/i.test(text);
  };
