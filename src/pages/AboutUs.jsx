...
const values = [
  {
    title: 'Innovation',
    body: 'We keep improving the product around the parts of resume work that are hardest to judge: structure, wording, review, and export.',
    path: 'M13 10V3L4 14h7v7l9-11h-7z',
  },
  {
    title: 'Accessibility',
    body: "Career opportunities shouldn't have barriers. We design the workflow around clear language, keyboard-friendly controls, and readable documents.",
    path: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z',
  },
  {
    title: 'Integrity',
    body: 'We explain what the product can and cannot verify, keep user review in the loop, and avoid presenting AI or ATS guidance as a hiring guarantee.',
    path: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z',
  },
  {
    title: 'Empowerment',
    body: 'You control the final resume. We provide structured editing, practical guidance, and export tools so you can make informed choices about your job search.',
  ...
  return (
    ...
    >
      <PageHero
        ...
        lead="At ResumeATS we're passionate about leveling the playing field for job seekers. We understand the frustration of crafting a resume that is hard for people or automated systems to review. We built a clearer way to present your qualifications."
          ...
          <section>
            ...
            <div className={cardClass}>
              <div className="space-y-4 text-gray-700 dark:text-slate-300">
                <p>
                  ResumeATS started with a practical question: why should a formatting parser decide whether a person gets a fair read? The product is built to help job seekers create clear, structured resumes that work for both people and the software employers use.
                </p>
                <p>
                  Our goal is to make the important parts of a job search easier to understand: what information to include, how to describe real experience, how to review an ATS checklist, and how to export a usable document.
                </p>
                <p>
                  AI features are optional. They help with drafting and tailoring, while you remain responsible for checking every claim before using a resume. That balance—useful assistance with clear user control—guides the product.
                </p>
              </div>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="rounded-2xl border border-blue-100 bg-gradient-to-br from-blue-50 via-blue-50 to-indigo-50 p-8 text-center shadow-sm sm:p-10 dark:border-blue-500/20 dark:from-blue-500/10 dark:via-blue-500/5 dark:to-indigo-500/10">
              <p className="mx-auto max-w-3xl text-lg font-medium leading-relaxed text-gray-800 dark:text-slate-100 sm:text-xl">
                &ldquo;To make resume work clearer and more accessible by giving every job seeker practical tools, honest guidance, and control over the story they tell.&rdquo;
              </p>
            </div>
          </section>
        </AnimatedElement>
        ...
        <AnimatedElement variants={fadeInUp} delay={0.05}>
          <section className="overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 via-blue-600 to-indigo-700 p-8 text-center shadow-lg sm:p-10">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-base text-blue-100 sm:text-lg">
              Now that you know us, let us help you make your next career move with clear editing, review, and export tools.
            </p>
            <div className="mt-6 flex justify-center">
              <TouchLink
                ...
                ariaLabel="Start building your resume"
              >
