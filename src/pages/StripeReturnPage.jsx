        ...
        return (
            <div className="app-loading-viewport flex-col bg-gray-100 dark:bg-slate-900 p-4 text-center">
                ...
                <Link
                    ...
                    className="inline-flex items-center justify-center px-6 py-2 mb-3 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700 transition-colors"
                >
                    Check Subscription Status
                </Link>
                <Link
                    to="/pricing"
                    className="inline-flex items-center justify-center px-6 py-2 bg-indigo-600 text-white font-semibold rounded-md hover:bg-indigo-700 transition-colors"
                >
                    Return to Pricing
                </Link>
            </div>
