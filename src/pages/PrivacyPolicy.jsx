...
const PrivacyPolicy = () => {
    return (
        ...
        >
            <motion.h1
                className="text-3xl font-bold mb-6 text-gray-800 dark:text-slate-100"
                variants={fadeInUp}
            >
                Privacy Policy
            </motion.h1>
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Introduction</h2>
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Information We Collect</h2>
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">How We Use Your Information</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed mb-3">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Data Storage and Security</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Sharing Your Information</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed mb-3">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Your Rights and Choices</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed mb-3">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Cookies and Tracking</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Children&apos;s Privacy</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Changes to This Policy</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
            ...
            <motion.section className="mb-6" variants={fadeInUp}>
                <h2 className="text-2xl font-semibold mb-3 text-gray-700 dark:text-slate-300">Contact Us</h2>
                <p className="text-gray-600 dark:text-slate-400 leading-relaxed">
                    If you have any questions about this Privacy Policy or our data practices, please contact us
                    at <a href={`mailto:${SUPPORT_EMAIL}`} className="text-blue-600 hover:underline">{SUPPORT_EMAIL}</a>, call us at{' '}
                    <a href={`tel:${SUPPORT_PHONE_URI}`} className="text-blue-600 hover:underline">{SUPPORT_PHONE_DISPLAY}</a>, or
                    visit our <Link to="/contact" className="text-blue-600 hover:underline">Contact page</Link>.
                </p>
            </motion.section>

            <motion.p className="text-sm text-gray-500 dark:text-slate-500 mt-8" variants={fadeInUp}>
